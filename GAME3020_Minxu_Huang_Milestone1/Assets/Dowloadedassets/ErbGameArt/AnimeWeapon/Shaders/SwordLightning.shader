...
Shader "ErbGameArt/SwordLightning" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 specularColor = pow(1.0-max(0,dot(i.normalDir, viewDirection)),_Fresnelpower);
                ...
                float3 emissive = (_Emissionmask_var.rgb*_Emissionpower*_Emissioncolor.rgb);
