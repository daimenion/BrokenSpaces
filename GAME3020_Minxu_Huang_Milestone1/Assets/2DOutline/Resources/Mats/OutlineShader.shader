		...
		SubShader
		{
			Pass
			{
				...
				half4 frag(v2f input) : COLOR
				{
					...
					half4 sample3 = tex2D(_OutlineSource, uv + float2(0.0,_LineThicknessY) * _MainTex_TexelSize.y * 1000.0f);
					half4 sample4 = tex2D(_OutlineSource, uv + float2(0.0,-_LineThicknessY) * _MainTex_TexelSize.y * 1000.0f);
					...
					if (outlineSource.a < h)
					{
						  ...
						  if (sample1.b > h || sample2.b > h || sample3.b > h || sample4.b > h)
						{
						  ...
						  if (sample1.r > h && sample1.b > h || sample2.r > h && sample2.b > h || sample3.r > h && sample3.b > h || sample4.r > h && sample4.b > h)
						{
							 outline = _LineColor4 * _LineIntensity;
							 hasOutline = true;
						}
					}
